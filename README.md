...
| __disableHeaderButtons__   | false | Prevent to change the calendar view with header buttons if minYear or maxYear are exceeded. Or previous or next month are fully disabled by disableUntil or disableSince. |
...
__pt-br__, __de__, __it__, __it-ch__, __pl__, __my__, __sk__, __sl__, __zh-cn__ and __he__. If the __locale__ attribute is used it overrides dayLabels, monthLabels, dateFormat, todayBtnTxt,
